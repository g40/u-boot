...
#define CONFIG_BOOTCOMMAND \
	...
	"setenv bootargs console=ttyS0,115200 earlyprintk rootwait rw ip=dhcp nfsroot=${server_ip}:/home/nfs_local,v3 root=/dev/nfs; " \
	"setenv autoload no; dhcp; " \
	"tftpboot 0x46000000 ${server_ip}:Image; " \
	"tftpboot 0x48000000 ${server_ip}:sun50i-h5-nanopi-k1-plus.dtb; " \
